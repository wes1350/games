...
describe("Board test", () => {
    ...
    it("should correctly score boards starting with spinner", () => {
        ...
        board = AddDomino(board, { head: 6, tail: 5 }, Direction.NORTH);
        expect(ScoreBoard(board)).to.eq(10);
        board = AddDomino(board, { head: 5, tail: 5 }, Direction.NORTH);
        expect(ScoreBoard(board)).to.eq(15);
        board = AddDomino(board, { head: 3, tail: 3 }, Direction.EAST);
        expect(ScoreBoard(board)).to.eq(0);
        board = AddDomino(board, { head: 2, tail: 2 }, Direction.WEST);
        expect(ScoreBoard(board)).to.eq(20);
        board = AddDomino(board, { head: 2, tail: 4 }, Direction.WEST);
        expect(ScoreBoard(board)).to.eq(20);
        board = AddDomino(board, { head: 6, tail: 1 }, Direction.SOUTH);
        expect(ScoreBoard(board)).to.eq(0);
        board = AddDomino(board, { head: 1, tail: 5 }, Direction.SOUTH);
    ...
    it("should correctly score boards starting without spinner", () => {
        ...
        board = AddDomino(board, { head: 6, tail: 4 }, Direction.NONE);
        expect(ScoreBoard(board)).to.eq(10);
        board = AddDomino(board, { head: 4, tail: 1 }, Direction.EAST);
        expect(ScoreBoard(board)).to.eq(0);
        board = AddDomino(board, { head: 1, tail: 3 }, Direction.EAST);
        expect(ScoreBoard(board)).to.eq(0);
        board = AddDomino(board, { head: 2, tail: 6 }, Direction.WEST);
        expect(ScoreBoard(board)).to.eq(5);
        board = AddDomino(board, { head: 5, tail: 2 }, Direction.WEST);
        expect(ScoreBoard(board)).to.eq(0);
        board = AddDomino(board, { head: 3, tail: 5 }, Direction.EAST);
        expect(ScoreBoard(board)).to.eq(10);
        board = AddDomino(board, { head: 5, tail: 5 }, Direction.WEST);
        expect(ScoreBoard(board)).to.eq(15);
        board = AddDomino(board, { head: 5, tail: 0 }, Direction.WEST);
        expect(ScoreBoard(board)).to.eq(5);
        board = AddDomino(board, { head: 0, tail: 0 }, Direction.WEST);
        expect(ScoreBoard(board)).to.eq(5);
        board = AddDomino(board, { head: 5, tail: 1 }, Direction.NORTH);
        expect(ScoreBoard(board)).to.eq(0);
        board = AddDomino(board, { head: 5, tail: 4 }, Direction.SOUTH);
        expect(ScoreBoard(board)).to.eq(10);
    });
    ...
    it("should correctly identify valid and invalid placements", () => {
        ...
        board = AddDomino(board, d66, Direction.NONE);
        ...
        board = AddDomino(board, d63, Direction.EAST);
        ...
        board = AddDomino(board, d33, Direction.EAST);
        ...
        board = AddDomino(board, d60, Direction.WEST);
        ...
        board = AddDomino(board, d62, Direction.SOUTH);
        ...
        board = AddDomino(board, d43, Direction.EAST);
        ...
        board = AddDomino(board, d64, Direction.NORTH);
